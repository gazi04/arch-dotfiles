...
alias socialMediaClone='cd /srv/http/socialMediaApp/src && nvim'
alias fdn='cd $(find -type d | fzf) && nvim .'
...
export PATH=$PATH:/home/gazi/.spicetify
cat ~/terminalBanner.txt | lolcat -f
